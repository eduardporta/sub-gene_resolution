...
#ARRANGE IT ALL
grid.arrange (arrangeGrob(empty.plot, gF, gG, empty.plot, empty.plot, empty.plot, gE, gA, gB, gC2, gC, gD, nrow = 2, widths = c (1/10, 4/5, 3/10, 2/25, 2/25, 2/5), heights = c (1, 15)), empty.plot, arrangeGrob(empty.plot, leg.heat, leg.known, leg.struc, empty.plot, nrow = 1, widths = c (7/2,2,4,2,1/4)), ncol = 1, heights = c (14,1/4,2))